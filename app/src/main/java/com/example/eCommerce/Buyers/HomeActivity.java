...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!type.equals("Admin") && !type.equals("Seller"))
                {
        ...
        if (!type.equals("Admin") && !type.equals("Seller")){
            ...
            Picasso.get().load(Prevalent.currentOnlineUsers.getImage()).placeholder(R.drawable.profile).into(profileImage);
    ...
    protected void onStart() {
        ...
        {
            final String sellerid= FirebaseAuth.getInstance().getCurrentUser().getUid();
            FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                    .setQuery(ProductRef.orderByChild("sellerID").equalTo(sellerid), Products.class).build();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        {
            Intent intent = new Intent(HomeActivity.this, AdminUserProductsActivity.class);
            intent.putExtra("uid",Prevalent.currentOnlineUsers.getPhone());
            startActivity(intent);
        }
